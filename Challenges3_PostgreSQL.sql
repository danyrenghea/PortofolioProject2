...
--Task 9:
--Task 9.1: Create a query that shows average daily revenues/incomes ao all Saturdays and of all Sundays 
--Question: What is the daily average revenue/income ( average amount for Sundays ) of all Sundays?
--Task 9.2 : Extract all the payment by payment_id made of the day 2020-01-25 by each 
